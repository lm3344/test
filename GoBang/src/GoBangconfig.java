...
public interface GoBangconfig {
	...
	Image MESSAGEPICTURE= new ImageIcon("pic\\MessagePictrue.jpg").getImage();
	Image LOGINPICTURE= new ImageIcon("pic\\LoginPicture.jpg").getImage();
	Image LOGINPICTURE2= new ImageIcon("pic\\LoginPicture2.jpg").getImage();
